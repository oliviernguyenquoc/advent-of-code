...
with open("./2024/day5/input.txt", encoding="utf-8") as f:
...
for programmed_update in update_not_ok:
    ...
    while i < len(programmed_update):
        ...
        while seen.intersection(rules[nb]) != set():
            ...
            programmed_update = programmed_update[:i-1] + [programmed_update[i]] + [programmed_update[i-1]] + programmed_update[i+1:]
            i -= 1
